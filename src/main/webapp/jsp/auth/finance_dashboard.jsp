...
<%
    ...
    if (!"FINANCE".equals(session.getAttribute("userRole"))) {
        response.sendRedirect(request.getContextPath() + "/login");
        return;
    }
%>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-card p { color: #1F4E79; font-size: 28px; font-weight: bold; }
    </style>
</head>
<body>
...
<div class="container">
    <div class="welcome">
        ...
        <p>View financial reports and payment summaries</p>
    </div>
    ...
    <div class="cards">
        <a href="${pageContext.request.contextPath}/report"
           class="card">
            ...
            <p>Generate and export income reports by date range</p>
        </a>
        <a href="${pageContext.request.contextPath}/report?action=summary"
           class="card">
            <div class="icon">💰</div>
